...
namespace rolly
{
  inline namespace types
  {
    ...
    guid::guid(std::string_view const str) {
      auto zeroify = [](guid& x) {
        std::fill(x.bytes_.begin(), x.bytes_.end(), 0_u8);
      };
    ...
    std::ostream& operator<<(std::ostream& os, guid const& guid) {
      ...
      os << std::hex << std::setfill('0')
         << std::setw(2) << static_cast<int>(guid.bytes()[0])
         << std::setw(2) << static_cast<int>(guid.bytes()[1])
         << std::setw(2) << static_cast<int>(guid.bytes()[2])
         << std::setw(2) << static_cast<int>(guid.bytes()[3])
         << "-"
         << std::setw(2) << static_cast<int>(guid.bytes()[4])
         << std::setw(2) << static_cast<int>(guid.bytes()[5])
         << "-"
         << std::setw(2) << static_cast<int>(guid.bytes()[6])
         << std::setw(2) << static_cast<int>(guid.bytes()[7])
         << "-"
         << std::setw(2) << static_cast<int>(guid.bytes()[8])
         << std::setw(2) << static_cast<int>(guid.bytes()[9])
         << "-"
         << std::setw(2) << static_cast<int>(guid.bytes()[10])
         << std::setw(2) << static_cast<int>(guid.bytes()[11])
         << std::setw(2) << static_cast<int>(guid.bytes()[12])
         << std::setw(2) << static_cast<int>(guid.bytes()[13])
         << std::setw(2) << static_cast<int>(guid.bytes()[14])
...
#if defined(ROLLY_OS_LINUX)
      static_assert(std::is_same_v<unsigned char[16], uuid_t>, "rolly::guid: uuid_t is not unsigned char[16]"); // NOLINT(*-avoid-c-arrays)
