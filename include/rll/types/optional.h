...
#    if defined(_LIBCPP_VERSION) && __cplusplus == 201'103L
...
#  endif
    ...
    template <class U>
    using fixup_void = conditional_t<std::is_void<U>::value, std::monostate, U>;
    ...
    using enable_forward_value = detail::enable_if_t<
      ...
      && ! std::is_same<detail::decay_t<U>, std::in_place_t>::value
    ...
    struct optional_storage_base {
      ...
      template <class... U>
      TL_OPTIONAL_11_CONSTEXPR optional_storage_base(std::in_place_t, U&&... u)
...
#  ifndef TL_OPTIONAL_NO_CONSTRR
      constexpr T const&& get() const&& { return std::move(this->m_value); }
#  endif
    };
    ...
    struct optional_copy_base<T, false> : optional_operations_base<T> {
      ...
      optional_copy_base& operator=(optional_copy_base const& rhs) = default;
...
#  endif
    ...
    struct optional_move_base<T, false> : optional_copy_base<T> {
      ...
      optional_move_base& operator=(optional_move_base const& rhs) = default;
    ...
    struct optional_copy_assign_base<T, false> : optional_move_base<T> {
      ...
      optional_copy_assign_base(optional_copy_assign_base const& rhs) = default;

      optional_copy_assign_base(optional_copy_assign_base&& rhs) = default;

      optional_copy_assign_base& operator=(optional_copy_assign_base const& rhs) {
        this->assign(rhs);
        return *this;
      }
...
#  endif
    ...
    struct optional_move_assign_base<T, false> : optional_copy_assign_base<T> {
      ...
      optional_move_assign_base(optional_move_assign_base const& rhs) = default;

      optional_move_assign_base(optional_move_assign_base&& rhs) = default;

      optional_move_assign_base& operator=(optional_move_assign_base const& rhs) = default;
    ...
    struct optional_delete_ctor_base {
      ...
      optional_delete_ctor_base(optional_delete_ctor_base const&) = default;
      optional_delete_ctor_base(optional_delete_ctor_base&&) noexcept = default;
      optional_delete_ctor_base& operator=(optional_delete_ctor_base const&) = default;
    ...
    struct optional_delete_ctor_base<T, false, true> {
      optional_delete_ctor_base() = default;
      optional_delete_ctor_base(optional_delete_ctor_base const&) = delete;
      optional_delete_ctor_base(optional_delete_ctor_base&&) noexcept = default;
      optional_delete_ctor_base& operator=(optional_delete_ctor_base const&) = default;
      optional_delete_ctor_base& operator=(optional_delete_ctor_base&&) noexcept = default;
    };
    ...
    struct optional_delete_assign_base {
      ...
      optional_delete_assign_base(optional_delete_assign_base const&) = default;
      optional_delete_assign_base(optional_delete_assign_base&&) noexcept = default;
      optional_delete_assign_base& operator=(optional_delete_assign_base const&) = default;
    ...
    struct optional_delete_assign_base<T, false, true> {
      ...
      optional_delete_assign_base(optional_delete_assign_base const&) = default;
      optional_delete_assign_base(optional_delete_assign_base&&) noexcept = default;
      optional_delete_assign_base& operator=(optional_delete_assign_base const&) = delete;
      optional_delete_assign_base& operator=(optional_delete_assign_base&&) noexcept = default;
    };
  ...
  class optional : private detail::optional_move_assign_base<T>,
    ...
    static_assert(
      ! std::is_same<T, std::in_place_t>::value,
      "instantiation of optional with std::in_place_t is ill-formed"
    );
    static_assert(
      ! std::is_same<detail::decay_t<T>, nullopt_t>::value,
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
  ...
  && ! defined(TL_OPTIONAL_GCC55)
    ...
    constexpr auto and_then(F&& f) const& {
      using result = detail::invoke_result_t<F, T const&>;
      static_assert(detail::is_optional<result>::value, "F must return an optional");
...
#  endif
    ...
    template <class F>
    constexpr detail::invoke_result_t<F, T const&> and_then(F&& f) const& {
      using result = detail::invoke_result_t<F, T const&>;
      static_assert(detail::is_optional<result>::value, "F must return an optional");
...
#  endif
  ...
  && ! defined(TL_OPTIONAL_GCC55)
    ...
    template <class F>
    constexpr decltype(optional_map_impl(std::declval<optional const&>(), std::declval<F&&>())
    ) map(F&& f) const& {
      return optional_map_impl(*this, std::forward<F>(f));
    }
...
#  endif
    ...
    TL_OPTIONAL_11_CONSTEXPR optional disjunction(optional const& rhs) & {
      return has_value() ? *this : rhs;
    }

    constexpr optional disjunction(optional const& rhs) const& { return has_value() ? *this : rhs; }
...
#ifndef TL_OPTIONAL_NO_CONSTRR
    constexpr optional disjunction(optional const& rhs) const&& {
      return has_value() ? std::move(*this) : rhs;
    }
#endif
    ...
    TL_OPTIONAL_11_CONSTEXPR optional(optional const& rhs) = default;
    ...
    constexpr explicit optional(
      detail::enable_if_t<std::is_constructible<T, Args...>::value, std::in_place_t>,
      Args&&... args
    )
    ...
    template <
      class U,
      detail::enable_from_other<T, U, U const&>* = nullptr,
      detail::enable_if_t<std::is_convertible<U const&, T>::value>* = nullptr>
    ...
    constexpr T const* operator->() const { return std::addressof(this->m_value); }
    ...
    constexpr T const& operator*() const& { return this->m_value; }

    TL_OPTIONAL_11_CONSTEXPR T&& operator*() && { return std::move(this->m_value); }

#ifndef TL_OPTIONAL_NO_CONSTRR
    constexpr T const&& operator*() const&& { return std::move(this->m_value); }
#endif
  ...
  template <class T>
  inline constexpr bool operator<(optional<T> const&, nullopt_t) noexcept {
    return false;
  }
  ...
  template <class T>
  inline constexpr bool operator<=(nullopt_t, optional<T> const&) noexcept {
    return true;
  }
...
#  ifdef TL_OPTIONAL_CXX14
    ...
    auto optional_map_impl(Opt&& opt, F&& f) {
      if(opt.has_value()) {
        ...
        return rll::make_optional(std::monostate {});
      }
...
#  else
    ...
    auto optional_map_impl(Opt&& opt, F&& f) -> optional<std::monostate> {
      if(opt.has_value()) {
        detail::invoke(std::forward<F>(f), *std::forward<Opt>(opt));
...
#  endif
    ...
    /// If `rhs` contains a value, the stored value is direct-initialized with
    /// it. Otherwise, the constructed optional is empty.
    TL_OPTIONAL_11_CONSTEXPR optional(optional const& rhs) noexcept = default;
    ...
    template <class U>
    constexpr explicit optional(optional<U> const& rhs) noexcept
      : optional(*rhs) {}
    ...
    /// resets the stored value in `*this`.
    template <class U>
    optional& operator=(optional<U> const& rhs) noexcept {
  ...
  [[nodiscard]] optional<std::decay_t<T>> some(T&& t) {
    return rll::optional<std::decay_t<T>>(std::forward<T>(t));
  }
