...
#  if defined(i386) || defined(__i386__) || defined(__i486__) || defined(__i586__) \
    ...
    || defined(__THW_INTEL__) || defined(__I86__) || defined(__INTEL__) || defined(DOXYGEN)
#    define RLL_ARCH_X86_32
...
#  elif defined(__ARM_ARCH) || defined(__TARGET_ARCH_ARM) || defined(__TARGET_ARCH_THUMB)  \
    ...
    || defined(DOXYGEN)
#    define RLL_ARCH_ARM
#  elif defined(__bfin__) || defined(__BFIN__) || defined(bfin) || defined(BFIN) || defined(DOXYGEN)
#    define RLL_ARCH_BFIN
...
#    define RLL_ARCH_M68K
#  elif defined(__mips__) || defined(__mips) || defined(__MIPS__) || defined(DOXYGEN)
#    define RLL_ARCH_MIPS
#  elif defined(__hppa__) || defined(__hppa) || defined(__HPPA__) || defined(DOXYGEN)
#    define RLL_ARCH_HPPA
