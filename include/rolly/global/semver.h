...
namespace rolly {
  ...
  namespace detail {
    ...
    class range {
     public:
      ROLLY_SEMVER_CONSTEXPR explicit range(std::string_view str) noexcept
        : parser {str} {}

      ROLLY_SEMVER_CONSTEXPR bool satisfies(version const& ver, bool include_prerelease) {
     ...
     private:
      ...
      struct range_lexer {
        ...
        ROLLY_SEMVER_CONSTEXPR void advance(std::size_t i) noexcept { pos += i; }
      ...
      struct range_parser {
        ...
        ROLLY_SEMVER_CONSTEXPR explicit range_parser(std::string_view str)
          : lexer {str}
    ...
    ROLLY_SEMVER_CONSTEXPR bool satisfies(
      version const& ver,
      std::string_view str,
