...
namespace leaf
{
        ...
        private detail::expected_default_ctor_base<T, E>
  {
    ...
    detail::enable_if_t<detail::is_swappable<OT>::value &&
      ...
      (std::is_nothrow_move_constructible<OT>::value ||
        std::is_nothrow_move_constructible<OE>::value)> swap(expected &rhs) noexcept(
      std::is_nothrow_move_constructible<T>::value
  ...
  constexpr auto operator==(const expected<void, E> &lhs,
                            const expected<void, F> &rhs) -> bool
  {
    return (lhs.has_value() != rhs.has_value())
        ? false
  ...
  template <class T, class E, class U>
  constexpr auto operator==(const expected<T, E> &x, const U &v) -> bool
  {
    return x.has_value() ? *x == v : false;
  }

  template <class T, class E, class U>
  constexpr auto operator==(const U &v, const expected<T, E> &x) -> bool
  {
    return x.has_value() ? *x == v : false;
  }
  ...
  template <class T, class E>
  constexpr auto operator==(const expected<T, E> &x, const unexpected<E> &e) -> bool
  {
    return x.has_value() ? false : x.error() == e.value();
  }

  template <class T, class E>
  constexpr auto operator==(const unexpected<E> &e, const expected<T, E> &x) -> bool
  {
    return x.has_value() ? false : x.error() == e.value();
  }
  ...
  template <class T, class E,
            detail::enable_if_t<(std::is_void_v<T> ||
