...
namespace leaf::log {
   ...
   * Основное предназначение этого класса - быстрая настройка логгера для отладки (например, для
   * тестов). \version 3.0.0
   */
  struct LEAF_EXPORT
    [[deprecated("Use leaf::Logger + leaf::LoggerBuilder instead")]] LogFileConfiguration
  {
